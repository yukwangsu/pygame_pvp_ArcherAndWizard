...
background = pygame.image.load(".\\궁수와 법사_background.png")

character1 = pygame.image.load(".\\character_1.png")
...
character2 = pygame.image.load(".\\character_2.png")
...
c_1_c = pygame.image.load(".\\character_1_c.png")
...
c_2_c = pygame.image.load(".\\character_2_c.png")
...
c_1_r = pygame.image.load(".\\character_1_r.png")
...
c_2_r = pygame.image.load(".\\character_2_r.png")
...
while runing:
    ...
    if re_event_c_1_r_stack == -8:
        re_event_c_1_r = True

    if re_event_c_2_r_stack == -5:
        re_event_c_2_r = True
